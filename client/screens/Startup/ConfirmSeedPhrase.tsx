...
const ConfirmSeedPhrase = () => {
  ...
  const confirmSeedPhrase = () => {
    const mnemonic = sortedSeedPhrase.toString().split(",").join(" ");
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={{ paddingHorizontal: 30, paddingBottom: 30 }}>
        ...
        <Text style={styles.subHeading}>
          Please enter your the missing words to makesure you’ve stored your
          seed phrase correctly. You cannot recover your account without it.
        </Text>
        <FlatList
